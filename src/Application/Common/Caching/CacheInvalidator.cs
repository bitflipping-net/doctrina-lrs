...
{
    /// <summary>
    /// Inherit from this class when you need to handle the case of one request type (TRequest) invalidating the cached
    ...
    public abstract class CacheInvalidator<TRequest, TCachedRequest, TCachedResponse> : ICacheInvalidator<TRequest>
